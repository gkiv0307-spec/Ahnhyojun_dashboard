...
(function (global) {
  ...
  function seedDemoBookings(d){
    ...
    var rows = [
      ...
      { off:-158, ci:-150, n:1, st:'SETTLED', u:'u_lhc', lo:'lo_3', rm:1, ad:1, ch:0, cost:142000, purpose:'김해점 매장 점검', bearer:'COMPANY' },
      ...
      { off:-112, ci:-106, n:2, st:'SETTLED', u:'u_ljh', lo:'lo_4', rm:1, ad:2, ch:0, cost:224000, purpose:'포항점 매장 점검', bearer:'COMPANY' },
      { off:-96, ci:-92, n:2, st:'SETTLED', u:'u_yhr', br:'대구점', lo:'lo_1', rm:2, ad:3, ch:0, cost:252000, purpose:'대구 인근 지점 순회 점검', bearer:'COMPANY' },
      ...
      /* 최근 진행건 */
      { off:-21, ci:-14, n:2, st:'SETTLED', u:'u_ljh', lo:'lo_5', rm:2, ad:8, ch:0, cost:0, purpose:'서부경남 지점장 교육', bearer:'COMPANY' },
      ...
      /* 오늘 체크인/체크아웃 */
      { off:-8,  ci:0,   n:2, st:'UPCOMING', u:'u_yhr', br:'대구점', lo:'lo_1', rm:1, ad:2, ch:0, cost:252000, purpose:'대구 인근 지점 순회 점검', bearer:'COMPANY' },
      { off:-7,  ci:0,   n:1, st:'UPCOMING', u:'u_ljh', lo:'lo_4', rm:2, ad:3, ch:0, cost:224000, purpose:'포항 지역 출장 숙박', bearer:'BRANCH' },
      { off:-9,  ci:-1,  n:1, st:'UPCOMING', u:'u_lhc', lo:'lo_3', rm:1, ad:1, ch:0, cost:142000, purpose:'김해점 매장 점검', bearer:'COMPANY' },
      /* 내일 체크인 */
