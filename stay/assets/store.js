...
(function (global) {
  ...
  function seed(d){
    ...
    /* 부동산팀은 접수·승인·예약 진행·정산을 팀으로 함께 처리한다.
     * 그래서 처리 계정도 팀 계정 하나로 통합했고, 노출 연락처는 이동현 사원 번호로 통일한다.
     * 개인별 처리자 구분이 필요해지면 여기에 팀원 계정을 추가하면 된다. */
    d.users = [
      { id:'u_team', name:'옆커폰 부동산팀', title:'', role:'admin', branch:'본사', dept:'부동산팀',
        phone:'010-8347-2699', email:'', active:true, canApprove:true,
        duty:'예약 접수 · 승인 · 예약 진행 · 정산 전 과정 처리 (문의: 이동현 사원)' }
    ];
    ...
    d.lodgings = [
      ...
      { id:'lo_2', name:'거제 펜션 풀빌라 스테이레브소유', type:'PENSION', ownership:'DIRECT', region:'경남',
        ...
        caution:'', note:'단체·가족 여행 활용 가능. 운영 정보 확인 필요', active:true },
    ...
    d.notices = [
      ...
      { id:uid('nc'), category:'제휴숙소 안내', pinned:false, author:'문소진', createdAt:nowIso, updatedAt:nowIso,
        title:'운영 숙소가 없는 지역은 어떻게 하나요',
        body:'현재 회사 운영 숙소는 대구(군위)·경남(거제·김해·진주)·경북(포항) 5곳입니다.\n\n' +
             '이 지역을 방문할 때는 운영 숙소를 우선 이용해주세요.\n' +
  ...
  function seedDemoBookings(d){
    ...
    var rows = [
      ...
      { off:-330, ci:-326, n:2, st:'SETTLED', br:'부산점', lo:'lo_2', rm:2, ad:4, ch:0, cost:330000, purpose:'거제 풀빌라 단체 여행', bearer:'BRANCH' },
      { off:-318, ci:-312, n:1, st:'SETTLED', lo:'lo_3', rm:1, ad:2, ch:0, cost:142000, purpose:'김해 가족 여행', bearer:'COMPANY' },
      { off:-300, ci:-295, n:2, st:'SETTLED', br:'대구점', lo:'lo_1', rm:1, ad:2, ch:0, cost:252000, purpose:'대구 근교 주말 여행', bearer:'COMPANY' },
      { off:-286, ci:-280, n:3, st:'SETTLED', lo:'lo_2', rm:3, ad:12, ch:0, cost:600000, purpose:'하계 휴가 여행', bearer:'COMPANY' },
      { off:-268, ci:-262, n:1, st:'SETTLED', lo:'lo_1', rm:2, ad:4, ch:0, cost:0, purpose:'군위 독채 가족 여행', bearer:'COMPANY' },
      { off:-252, ci:-246, n:2, st:'SETTLED', lo:'lo_4', rm:2, ad:3, ch:0, cost:224000, purpose:'포항 바다 여행', bearer:'BRANCH' },
      { off:-238, ci:-232, n:1, st:'SETTLED', lo:'lo_3', rm:2, ad:3, ch:0, cost:284000, purpose:'부산 근교 주말 여행', bearer:'COMPANY' },
      { off:-220, ci:-214, n:2, st:'SETTLED', br:'부산점', lo:'lo_2', rm:1, ad:2, ch:0, cost:330000, purpose:'경남 일대 가족 여행', bearer:'BRANCH' },
      { off:-205, ci:-198, n:2, st:'SETTLED', lo:'lo_5', rm:2, ad:9, ch:0, cost:0, purpose:'진주 1박 여행', bearer:'COMPANY' },
      { off:-190, ci:-184, n:1, st:'SETTLED', br:'대구점', lo:'lo_1', rm:1, ad:2, ch:1, cost:126000, purpose:'대구 근교 나들이', bearer:'COMPANY' },
      { off:-172, ci:-166, n:2, st:'SETTLED', lo:'lo_2', rm:2, ad:8, ch:2, cost:400000, purpose:'우수사원 포상 휴양', bearer:'BRANCH' },
      { off:-158, ci:-150, n:1, st:'SETTLED', lo:'lo_3', rm:1, ad:1, ch:0, cost:142000, purpose:'김해 주말 휴양', bearer:'COMPANY' },
      { off:-140, ci:-134, n:2, st:'SETTLED', br:'부산점', lo:'lo_2', rm:2, ad:4, ch:0, cost:330000, purpose:'거제 단체 여행', bearer:'COMPANY' },
      { off:-126, ci:-120, n:1, st:'SETTLED', lo:'lo_1', rm:1, ad:2, ch:0, cost:0, purpose:'신입사원 단합 여행', bearer:'COMPANY' },
      { off:-112, ci:-106, n:2, st:'SETTLED', lo:'lo_4', rm:1, ad:2, ch:0, cost:224000, purpose:'포항 바다 나들이', bearer:'COMPANY' },
      { off:-96, ci:-92, n:2, st:'SETTLED', br:'대구점', lo:'lo_1', rm:2, ad:3, ch:0, cost:252000, purpose:'대구 근교 힐링 여행', bearer:'COMPANY' },
      { off:-88, ci:-84, n:1, st:'SETTLED', lo:'lo_3', rm:1, ad:2, ch:0, cost:142000, purpose:'부산 시내 여행', bearer:'COMPANY' },
      { off:-70, ci:-66, n:2, st:'SETTLED', br:'부산점', lo:'lo_2', rm:2, ad:4, ch:0, cost:330000, purpose:'거제 풀빌라 단체 여행', bearer:'BRANCH' },
      { off:-64, ci:-60, n:1, st:'SETTLED', lo:'lo_4', rm:1, ad:1, ch:0, cost:112000, purpose:'포항 1박 여행', bearer:'COMPANY' },
      { off:-58, ci:-54, n:3, st:'SETTLED', lo:'lo_2', rm:3, ad:12, ch:0, cost:600000, purpose:'하계 휴가 여행', bearer:'COMPANY' },
      { off:-44, ci:-40, n:1, st:'SETTLED', lo:'lo_1', rm:1, ad:2, ch:0, cost:0, purpose:'대구 근교 주말 여행', bearer:'COMPANY' },
      { off:-38, ci:-34, n:2, st:'SETTLED', br:'대구점', lo:'lo_1', rm:1, ad:2, ch:1, cost:252000, purpose:'군위 독채 가족 여행', bearer:'COMPANY' },
      { off:-33, ci:-29, n:1, st:'SETTLED', lo:'lo_3', rm:2, ad:3, ch:0, cost:284000, purpose:'김해 가족 여행', bearer:'COMPANY' },
      { off:-26, ci:-20, n:2, st:'SETTLED', br:'부산점', lo:'lo_2', rm:1, ad:2, ch:0, cost:330000, purpose:'경남 일대 가족 여행', bearer:'BRANCH' },
      /* 최근 진행건 */
      { off:-21, ci:-14, n:2, st:'SETTLED', lo:'lo_5', rm:2, ad:8, ch:0, cost:0, purpose:'서부경남 가족 여행', bearer:'COMPANY' },
      { off:-16, ci:-8,  n:1, st:'SETTLED', lo:'lo_4', rm:1, ad:1, ch:0, cost:112000, purpose:'경북 동해안 여행', bearer:'COMPANY' },
      { off:-13, ci:-6,  n:2, st:'SETTLING', br:'대구점', lo:'lo_1', rm:2, ad:4, ch:0, cost:252000, purpose:'대구 근교 나들이', bearer:'BRANCH' },
      { off:-12, ci:-5,  n:1, st:'SETTLE_WAIT', lo:'lo_3', rm:1, ad:2, ch:0, cost:142000, purpose:'부산 근교 주말 여행', bearer:'COMPANY' },
      { off:-11, ci:-4,  n:1, st:'SETTLE_WAIT', lo:'lo_1', rm:2, ad:4, ch:0, cost:0, purpose:'신입사원 단합 여행', bearer:'COMPANY' },
      { off:-10, ci:-2,  n:2, st:'SETTLE_WAIT', br:'부산점', lo:'lo_2', rm:2, ad:4, ch:1, cost:363000, purpose:'우수사원 포상 휴양', bearer:'COMPANY' },
      { off:-9,  ci:-1,  n:1, st:'USED', lo:'lo_2', rm:1, ad:4, ch:2, cost:200000, purpose:'거제 단체 여행', bearer:'BRANCH' },
      /* 오늘 체크인/체크아웃 */
      { off:-8,  ci:0,   n:2, st:'UPCOMING', br:'대구점', lo:'lo_1', rm:1, ad:2, ch:0, cost:252000, purpose:'대구 근교 힐링 여행', bearer:'COMPANY' },
      { off:-7,  ci:0,   n:1, st:'UPCOMING', lo:'lo_4', rm:2, ad:3, ch:0, cost:224000, purpose:'포항 바다 여행', bearer:'BRANCH' },
      { off:-9,  ci:-1,  n:1, st:'UPCOMING', lo:'lo_3', rm:1, ad:1, ch:0, cost:142000, purpose:'김해 주말 휴양', bearer:'COMPANY' },
      /* 내일 체크인 */
      { off:-6,  ci:1,   n:2, st:'BOOKED', br:'부산점', lo:'lo_2', rm:2, ad:4, ch:0, cost:330000, purpose:'거제 풀빌라 단체 여행', bearer:'BRANCH' },
      { off:-5,  ci:3,   n:1, st:'BOOKED', lo:'lo_1', rm:1, ad:2, ch:0, cost:0, purpose:'대구 근교 주말 여행', bearer:'COMPANY' },
      { off:-4,  ci:8,   n:3, st:'BOOKING', lo:'lo_2', rm:3, ad:14, ch:0, cost:600000, purpose:'하계 휴가 여행', bearer:'COMPANY' },
      { off:-3,  ci:12,  n:2, st:'APPROVED', br:'대구점', lo:'lo_1', rm:2, ad:4, ch:0, cost:252000, purpose:'군위 독채 가족 여행', bearer:'COMPANY' },
      { off:-2,  ci:14,  n:1, st:'APPROVAL_PENDING', lo:'lo_3', rm:2, ad:3, ch:0, cost:284000, purpose:'부산 시내 여행', bearer:'COMPANY' },
      { off:-2,  ci:16,  n:2, st:'APPROVAL_PENDING', br:'부산점', lo:'lo_2', rm:3, ad:6, ch:0, cost:495000, purpose:'경남 일대 가족 여행', bearer:'COMPANY' },
      { off:-1,  ci:20,  n:2, st:'REVIEWING', lo:'lo_5', rm:2, ad:10, ch:0, cost:0, purpose:'진주 단체 여행', bearer:'COMPANY' },
      { off:-1,  ci:10,  n:1, st:'RECEIVED', lo:'lo_1', rm:1, ad:2, ch:1, cost:0, purpose:'대구 근교 나들이', bearer:'BRANCH' },
      { off:0,   ci:18,  n:2, st:'NEW', br:'대구점', lo:'lo_1', rm:2, ad:4, ch:0, cost:252000, purpose:'신입사원 단합 여행', bearer:'COMPANY' },
      { off:0,   ci:25,  n:1, st:'NEW', lo:'lo_2', rm:2, ad:6, ch:2, cost:400000, purpose:'우수사원 포상 휴양', bearer:'COMPANY' },
      /* 취소/반려 */
      { off:-15, ci:-3,  n:1, st:'CANCELED', lo:'lo_3', rm:1, ad:1, ch:0, cost:142000, purpose:'김해 가족 여행', bearer:'COMPANY' },
      { off:-18, ci:-9,  n:2, st:'REJECTED', br:'부산점', lo:'lo_2', rm:4, ad:8, ch:0, cost:1320000, purpose:'거제 단체 여행', bearer:'COMPANY' }
    ];

    /* 신청자는 계정이 없는 지점 담당자다(실제로도 링크로 들어와 이름을 직접 적는다).
     * 이름은 예시용이며 연락처는 자리표시자로 둔다. */
    var applicants = [
      { name:'김도현', branch:'대구점',   dept:'지점' },
      { name:'박지훈', branch:'부산점',   dept:'지점' },
      { name:'이수민', branch:'포항점',   dept:'지점' },
      { name:'정한별', branch:'진주점',   dept:'지점' },
      { name:'최우진', branch:'김해점',   dept:'지점' }
    ];
    var team = byId['u_team'];

    d.bookings = rows.map(function(r, i){
      var reqAt = addDays(today, r.off); reqAt.setHours(9 + (i%8), (i*7)%60, 0, 0);
      var ap = applicants[i % applicants.length];
      var u = { id:null, name:ap.name, role:'applicant', branch:r.br || ap.branch,
                dept:ap.dept, phone:'010-0000-0000' };
      var lo = loById[r.lo];
      ...
      var b = {
        ...
        applicantId: null, applicantName: u.name, branch: u.branch, dept: u.dept, phone: u.phone,
        purpose: r.purpose,
      ...
      if (st === 'REJECTED') {
        b.approval.result = 'REJECTED'; b.approval.approverId=team.id; b.approval.approverName=team.name;
        b.approval.opinion = '동일 기간 타 지점 예약과 중복되며 인원 대비 객실 수가 과다합니다. 객실 수 조정 후 재신청 바랍니다.';
        b.approval.decidedAt = step(180);
        log(b.approval.decidedAt, team, '반려', b.approval.opinion, 'APPROVAL_PENDING', 'REJECTED');
      } else if (reach >= 5) {
        b.approval.result = 'APPROVED'; b.approval.approverId=team.id; b.approval.approverName=team.name;
        b.approval.opinion = '이용 목적 확인. 승인합니다.'; b.approval.decidedAt = step(120);
        log(b.approval.decidedAt, team, '승인', b.approval.opinion, 'APPROVAL_PENDING', 'APPROVED');
      }
      if (reach >= 6 && st !== 'REJECTED') log(step(40), assignee, '숙소 예약 진행', lo.name + ' 예약 문의', 'APPROVED', 'BOOKING');
      if (st === 'CANCELED') {
        b.cancelRequest = { at: step(60), reason:'여행 일정이 변경되어 취소 요청드립니다.', by:u.name, handled:true };
      ...
      if (reach >= 11 && !terminal) {
        ...
        b.payment.financeId=team.id; b.payment.financeName=team.name;
        log(step(120), team, '정산 시작',
      ...
      if (reach >= 12 && !terminal) {
        ...
        log(b.payment.settledAt, team, '정산 완료',
  ...
  var Store = {
    ...
    /* id 를 직접 지정해 새로 넣는 경우도 있으므로 "있으면 갱신, 없으면 추가"로 처리한다. */
    saveUser: function(u){
      var d = _read();
      var exists = u.id && d.users.some(function(x){ return x.id === u.id; });
      if (exists) { d.users = d.users.map(function(x){ return x.id===u.id ? Object.assign({}, x, u) : x; }); }
      else { if (!u.id) u.id = uid('u'); u.active = u.active !== false; d.users.push(u); }
      _write(); return u;
    },
    removeUser: function(id){ var d=_read(); d.users = d.users.filter(function(u){return u.id!==id;}); _write(); },
    saveLodging: function(l){
      var d = _read();
      var exists = l.id && d.lodgings.some(function(x){ return x.id === l.id; });
      if (exists) { d.lodgings = d.lodgings.map(function(x){ return x.id===l.id ? Object.assign({}, x, l) : x; }); }
      else { if (!l.id) l.id = uid('lo'); l.active = l.active !== false; d.lodgings.push(l); }
      _write(); return l;
    },
