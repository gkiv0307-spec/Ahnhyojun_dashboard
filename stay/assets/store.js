...
(function (global) {
  ...
  function seedDemoBookings(d){
    ...
    var rows = [
      ...
      { off:-330, ci:-326, n:2, st:'SETTLED', u:'u_lhc', br:'부산점', lo:'lo_2', rm:2, ad:4, ch:0, cost:330000, purpose:'거제 풀빌라 단체 여행', bearer:'BRANCH' },
      { off:-318, ci:-312, n:1, st:'SETTLED', u:'u_lhc', lo:'lo_3', rm:1, ad:2, ch:0, cost:142000, purpose:'김해 가족 여행', bearer:'COMPANY' },
      { off:-300, ci:-295, n:2, st:'SETTLED', u:'u_yhr', br:'대구점', lo:'lo_1', rm:1, ad:2, ch:0, cost:252000, purpose:'대구 근교 주말 여행', bearer:'COMPANY' },
      { off:-286, ci:-280, n:3, st:'SETTLED', u:'u_yhr', lo:'lo_2', rm:3, ad:12, ch:0, cost:600000, purpose:'하계 휴가 여행', bearer:'COMPANY' },
      { off:-268, ci:-262, n:1, st:'SETTLED', u:'u_ygh', lo:'lo_1', rm:2, ad:4, ch:0, cost:0, purpose:'군위 독채 가족 여행', bearer:'COMPANY' },
      { off:-252, ci:-246, n:2, st:'SETTLED', u:'u_ljh', lo:'lo_4', rm:2, ad:3, ch:0, cost:224000, purpose:'포항 바다 여행', bearer:'BRANCH' },
      { off:-238, ci:-232, n:1, st:'SETTLED', u:'u_lhc', lo:'lo_3', rm:2, ad:3, ch:0, cost:284000, purpose:'부산 근교 주말 여행', bearer:'COMPANY' },
      { off:-220, ci:-214, n:2, st:'SETTLED', u:'u_lhc', br:'부산점', lo:'lo_2', rm:1, ad:2, ch:0, cost:330000, purpose:'경남 일대 가족 여행', bearer:'BRANCH' },
      { off:-205, ci:-198, n:2, st:'SETTLED', u:'u_ljh', lo:'lo_5', rm:2, ad:9, ch:0, cost:0, purpose:'진주 1박 여행', bearer:'COMPANY' },
      { off:-190, ci:-184, n:1, st:'SETTLED', u:'u_yhr', br:'대구점', lo:'lo_1', rm:1, ad:2, ch:1, cost:126000, purpose:'대구 근교 나들이', bearer:'COMPANY' },
      { off:-172, ci:-166, n:2, st:'SETTLED', u:'u_yhr', lo:'lo_2', rm:2, ad:8, ch:2, cost:400000, purpose:'우수사원 포상 휴양', bearer:'BRANCH' },
      { off:-158, ci:-150, n:1, st:'SETTLED', u:'u_lhc', lo:'lo_3', rm:1, ad:1, ch:0, cost:142000, purpose:'김해 주말 휴양', bearer:'COMPANY' },
      { off:-140, ci:-134, n:2, st:'SETTLED', u:'u_lhc', br:'부산점', lo:'lo_2', rm:2, ad:4, ch:0, cost:330000, purpose:'거제 단체 여행', bearer:'COMPANY' },
      { off:-126, ci:-120, n:1, st:'SETTLED', u:'u_ygh', lo:'lo_1', rm:1, ad:2, ch:0, cost:0, purpose:'신입사원 단합 여행', bearer:'COMPANY' },
      { off:-112, ci:-106, n:2, st:'SETTLED', u:'u_ljh', lo:'lo_4', rm:1, ad:2, ch:0, cost:224000, purpose:'포항 바다 나들이', bearer:'COMPANY' },
      { off:-96, ci:-92, n:2, st:'SETTLED', u:'u_yhr', br:'대구점', lo:'lo_1', rm:2, ad:3, ch:0, cost:252000, purpose:'대구 근교 힐링 여행', bearer:'COMPANY' },
      { off:-88, ci:-84, n:1, st:'SETTLED', u:'u_lhc', lo:'lo_3', rm:1, ad:2, ch:0, cost:142000, purpose:'부산 시내 여행', bearer:'COMPANY' },
      { off:-70, ci:-66, n:2, st:'SETTLED', u:'u_lhc', br:'부산점', lo:'lo_2', rm:2, ad:4, ch:0, cost:330000, purpose:'거제 풀빌라 단체 여행', bearer:'BRANCH' },
      { off:-64, ci:-60, n:1, st:'SETTLED', u:'u_ljh', lo:'lo_4', rm:1, ad:1, ch:0, cost:112000, purpose:'포항 1박 여행', bearer:'COMPANY' },
      { off:-58, ci:-54, n:3, st:'SETTLED', u:'u_yhr', lo:'lo_2', rm:3, ad:12, ch:0, cost:600000, purpose:'하계 휴가 여행', bearer:'COMPANY' },
      { off:-44, ci:-40, n:1, st:'SETTLED', u:'u_ygh', lo:'lo_1', rm:1, ad:2, ch:0, cost:0, purpose:'대구 근교 주말 여행', bearer:'COMPANY' },
      { off:-38, ci:-34, n:2, st:'SETTLED', u:'u_yhr', br:'대구점', lo:'lo_1', rm:1, ad:2, ch:1, cost:252000, purpose:'군위 독채 가족 여행', bearer:'COMPANY' },
      { off:-33, ci:-29, n:1, st:'SETTLED', u:'u_lhc', lo:'lo_3', rm:2, ad:3, ch:0, cost:284000, purpose:'김해 가족 여행', bearer:'COMPANY' },
      { off:-26, ci:-20, n:2, st:'SETTLED', u:'u_lhc', br:'부산점', lo:'lo_2', rm:1, ad:2, ch:0, cost:330000, purpose:'경남 일대 가족 여행', bearer:'BRANCH' },
      /* 최근 진행건 */
      { off:-21, ci:-14, n:2, st:'SETTLED', u:'u_ljh', lo:'lo_5', rm:2, ad:8, ch:0, cost:0, purpose:'서부경남 가족 여행', bearer:'COMPANY' },
      { off:-16, ci:-8,  n:1, st:'SETTLED', u:'u_yhr', lo:'lo_4', rm:1, ad:1, ch:0, cost:112000, purpose:'경북 동해안 여행', bearer:'COMPANY' },
      { off:-13, ci:-6,  n:2, st:'SETTLING', u:'u_yhr', br:'대구점', lo:'lo_1', rm:2, ad:4, ch:0, cost:252000, purpose:'대구 근교 나들이', bearer:'BRANCH' },
      { off:-12, ci:-5,  n:1, st:'SETTLE_WAIT', u:'u_lhc', lo:'lo_3', rm:1, ad:2, ch:0, cost:142000, purpose:'부산 근교 주말 여행', bearer:'COMPANY' },
      { off:-11, ci:-4,  n:1, st:'SETTLE_WAIT', u:'u_ygh', lo:'lo_1', rm:2, ad:4, ch:0, cost:0, purpose:'신입사원 단합 여행', bearer:'COMPANY' },
      { off:-10, ci:-2,  n:2, st:'SETTLE_WAIT', u:'u_lhc', br:'부산점', lo:'lo_2', rm:2, ad:4, ch:1, cost:363000, purpose:'우수사원 포상 휴양', bearer:'COMPANY' },
      { off:-9,  ci:-1,  n:1, st:'USED', u:'u_yhr', lo:'lo_2', rm:1, ad:4, ch:2, cost:200000, purpose:'거제 단체 여행', bearer:'BRANCH' },
      /* 오늘 체크인/체크아웃 */
      { off:-8,  ci:0,   n:2, st:'UPCOMING', u:'u_yhr', br:'대구점', lo:'lo_1', rm:1, ad:2, ch:0, cost:252000, purpose:'대구 근교 힐링 여행', bearer:'COMPANY' },
      { off:-7,  ci:0,   n:1, st:'UPCOMING', u:'u_ljh', lo:'lo_4', rm:2, ad:3, ch:0, cost:224000, purpose:'포항 바다 여행', bearer:'BRANCH' },
      { off:-9,  ci:-1,  n:1, st:'UPCOMING', u:'u_lhc', lo:'lo_3', rm:1, ad:1, ch:0, cost:142000, purpose:'김해 주말 휴양', bearer:'COMPANY' },
      /* 내일 체크인 */
      { off:-6,  ci:1,   n:2, st:'BOOKED', u:'u_lhc', br:'부산점', lo:'lo_2', rm:2, ad:4, ch:0, cost:330000, purpose:'거제 풀빌라 단체 여행', bearer:'BRANCH' },
      { off:-5,  ci:3,   n:1, st:'BOOKED', u:'u_ygh', lo:'lo_1', rm:1, ad:2, ch:0, cost:0, purpose:'대구 근교 주말 여행', bearer:'COMPANY' },
      { off:-4,  ci:8,   n:3, st:'BOOKING', u:'u_yhr', lo:'lo_2', rm:3, ad:14, ch:0, cost:600000, purpose:'하계 휴가 여행', bearer:'COMPANY' },
      { off:-3,  ci:12,  n:2, st:'APPROVED', u:'u_yhr', br:'대구점', lo:'lo_1', rm:2, ad:4, ch:0, cost:252000, purpose:'군위 독채 가족 여행', bearer:'COMPANY' },
      { off:-2,  ci:14,  n:1, st:'APPROVAL_PENDING', u:'u_lhc', lo:'lo_3', rm:2, ad:3, ch:0, cost:284000, purpose:'부산 시내 여행', bearer:'COMPANY' },
      { off:-2,  ci:16,  n:2, st:'APPROVAL_PENDING', u:'u_lhc', br:'부산점', lo:'lo_2', rm:3, ad:6, ch:0, cost:495000, purpose:'경남 일대 가족 여행', bearer:'COMPANY' },
      { off:-1,  ci:20,  n:2, st:'REVIEWING', u:'u_ljh', lo:'lo_5', rm:2, ad:10, ch:0, cost:0, purpose:'진주 단체 여행', bearer:'COMPANY' },
      { off:-1,  ci:10,  n:1, st:'RECEIVED', u:'u_ygh', lo:'lo_1', rm:1, ad:2, ch:1, cost:0, purpose:'대구 근교 나들이', bearer:'BRANCH' },
      { off:0,   ci:18,  n:2, st:'NEW', u:'u_yhr', br:'대구점', lo:'lo_1', rm:2, ad:4, ch:0, cost:252000, purpose:'신입사원 단합 여행', bearer:'COMPANY' },
      { off:0,   ci:25,  n:1, st:'NEW', u:'u_yhr', lo:'lo_2', rm:2, ad:6, ch:2, cost:400000, purpose:'우수사원 포상 휴양', bearer:'COMPANY' },
      /* 취소/반려 */
      { off:-15, ci:-3,  n:1, st:'CANCELED', u:'u_lhc', lo:'lo_3', rm:1, ad:1, ch:0, cost:142000, purpose:'김해 가족 여행', bearer:'COMPANY' },
      { off:-18, ci:-9,  n:2, st:'REJECTED', u:'u_lhc', br:'부산점', lo:'lo_2', rm:4, ad:8, ch:0, cost:1320000, purpose:'거제 단체 여행', bearer:'COMPANY' }
    ];
